                ...
                if ($results != NULL) {
                    ...
                    if ($results->passivescan == 0){ 
                        ...
                        if (strpos($results->instrument, "2") !== false) {
                            ...
                            if ($tools_amount_amass < 4 && $tools_amount_jsa <=15) {
                        ...
                        if (strpos($results->instrument, "3") !== false) {
                            ...
                            if ( ($tools_amount_ffuf < 100 && $tools_amount_amass < 4) || ($tools_amount_ffuf < 75 && $tools_amount_jsa <=10) ) {
                        ...
                        if (strpos($results->instrument, "7") !== false) {
                            ...
                            if ($tools_amount_ffuf < 100 && $tools_amount_amass < 6) {
                        ...
                        if (strpos($results->instrument, "8") !== false) {
                            ...
                            if ($tools_amount_nuclei < 20 && $tools_amount_amass < 5) {
                        ...
                        if (strpos($results->instrument, "9") !== false) {
                            ...
                            if ($tools_amount_jsa < 8 && $tools_amount_amass < 4) {

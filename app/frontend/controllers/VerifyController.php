...
class VerifyController extends Controller
{
    public function actionQueue()
    {
        ...
        if ($secret === $secretIN) {
            ...
            //$max_amass = 0; $max_ffuf =0; $max_vhost = 0; $max_jsa = 0; $max_nuclei = 0; $max_nmap = 0; $max_nuclei_in_task = 250; $max_ips = 2; $max_whatweb = 0; $max_whatweb_in_task = 300;


            $max_amass = 2; $max_ffuf = 100; $max_nmap = 5; $max_vhost = 20; $max_nuclei = 0; $max_nuclei_in_task = 600; $max_ips = 2; $max_whatweb = 0; $max_whatweb_in_task = 50;  $max_nmap_in_task = 1; $max_forbiddenbypass = 0; $max_forbiddenbypass_in_task = 10;

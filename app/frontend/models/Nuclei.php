...
class Nuclei extends ActiveRecord
{
    ...
    public function Nucleiscan($list, $randomid)
    {
        ...
        $nuclei_start = "sudo docker run --rm --cpu-shares 256 --network=docker_default -v nuclei:/nuclei -v configs:/root/ projectdiscovery/nuclei -t /root/nuclei-templates/ -list " . escapeshellarg($list) . " -stats -o " . $output . " -json -irr -retries 3 -max-host-error 5000 -timeout 25 -rl 5 -bs 500 -c 5 " . $exclude . $headers; 

...
class Nmap extends ActiveRecord
{
    ...
    public function nmapips($input)
    {
        ...
        exec("sudo docker run --cpu-shares 256 --rm --privileged=true --network=host --expose=53 -p=53 -v configs:/configs/ -v dockerresults:/dockerresults instrumentisto/nmap --privileged -sT -g 53"

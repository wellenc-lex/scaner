...
class VerifyController extends Controller
{
    public static function actionQueue()
    {
        ...
        if ($secret === $secretIN) {
            ...
            $max_amass = 8; $max_ffuf = 170; $max_nmap = 2; $max_vhost = 0; $max_nuclei = 1; $max_nuclei_in_task = 100; $max_ips = 2; $max_whatweb = 1; $max_whatweb_in_task = 50;  $max_nmap_in_task = 500; $max_forbiddenbypass = 0; $max_forbiddenbypass_in_task = 10;

            $max_passive_amass = 8; $max_nuclei=6;

            ...
            try{
                ...
                if (isset( $url["tech"] )) {
                    ...
                    if (preg_match('/Basic/', $whatweb->tech) === 1) {
                        ...
                        $queue->instrument = 11; //http basic brute
                        $queue->save();
                    }
                }

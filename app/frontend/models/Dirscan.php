...
class Dirscan extends ActiveRecord
{
    public static function dirscan($input)
    {
        ...
        foreach ($urls as $url){
            ...
            $extensions = "_,0,~,~1,1,2,php,conf,config,db,sql,zip,tar,rar,tgz,tar.gz,php~";
            ...
            $ffuf_string = "sleep 3 && /go/ffuf/ffuf -maxtime 2999000 -mc all -fc 504,501,404,403,429,503,502,406,520,522 -fs 612,613,548,26,25,0,696956 -s -timeout 150 -t 1 -rate 2 -p 2 -fr 'Selligent Marketing Cloud|Incapusla Incident|shopify|okta|medium.com|Vercel|Too Many Requests|blocked by|Blocked by|Please wait while|Thank you for using nginx|Welcome to nginx|Scan your infrastructure with us|Ubuntu Default Page|It works!|Welcome to CentOS|cloudflareaccess.com|rs_weight=1|This page is used to test the proper operation of the|cause potential threats|This directory contains your static files|The requested URL was rejected|HTTP Error: 414|Cloudflare is currently unable to resolve your|400 Bad Request' -r -ac -noninteractive ";

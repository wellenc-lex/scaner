...
//--net=host
        $command = ("sudo docker run  --cpu-shares 256 --rm -v configs:/configs/ -v dockerresults:/dockerresults caffix/amass:v3.23.3 enum -w /configs/amass/amasswordlistASSETNOTE -d  " . escapeshellarg($url) . " -json " . $enumoutput . " -active -brute -timeout 1000 -ip -config ".$amassconfig);

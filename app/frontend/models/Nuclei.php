...
class Nuclei extends ActiveRecord
{
    ...
    {
        $exclude = " -exclude-templates /root/nuclei-templates/fuzzing,/root/nuclei-templates/dns,/root/nuclei-templates/miscellaneous,/root/nuclei-templates/technologies/tech-detect.yaml,/root/nuclei-templates/technologies/aws,/root/nuclei-templates/technologies/waf-detect.yaml,/root/nuclei-templates/misconfiguration/http-missing-security-headers.yaml,/root/nuclei-templates/misconfiguration/cloudflare-image-ssrf.yaml,/root/nuclei-templates/cves/2018/CVE-2018-15473.yaml,/root/nuclei-templates/vulnerabilities/generic/cors-misconfig.yaml,/root/nuclei-templates/cves/2018/CVE-2017-5487.yaml,/root/nuclei-templates/cves/2018/CVE-2021-38314.yaml,/root/nuclei-templates/cves/2016/CVE-2016-10940.yaml,/root/nuclei-templates/cves/2016/CVE-2017-5487.yaml,/root/nuclei-templates/vulnerabilities/generic/open-redirect.yaml,/root/nuclei-templates/ssl/deprecated-tls.yaml,/root/nuclei/Custom-Nuclei-Templates/shells.yaml ,/root/nuclei/Custom-Nuclei-Templates/header_sqli.yaml,/root/nuclei/Custom-Nuclei-Templates/templates/sqli_header.yaml,/root/nuclei/header_reflection_body.yaml,/root/nuclei-templates/technologies/nginx/nginx-version.yaml "; //,/root/nuclei-templates/helpers,/root/nuclei-templates/token-spray/,/root/nuclei-templates/exposures/tokens/generic/ -etags xss 
...
//--net=container:vpn2 -hang-monitor
        $nuclei_start = "sudo docker run --rm --cpu-shares 512 -v nuclei:/nuclei -v configs:/root/ projectdiscovery/nuclei -t /root/nuclei/ -w /root/nuclei-templates/workflows -t /root/nuclei-templates/ -w /root/nuclei-templates/workflows -t /root/nuclei-custom/5.log4j.yaml -list " . escapeshellarg($list) . " -o " . $output . " -j -irr -max-host-error 200 -timeout 130 -rl 5 -bs 50 -c 5 -hbs 5 -fr -mr 5 -stats -retries 3 -error-log /nuclei/error.log -page-timeout 120 -ztls -disable-update-check -system-resolvers  " . $exclude . $headers;

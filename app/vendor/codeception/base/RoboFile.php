    ...
    public function publishPhar()
    {
        ...
        foreach ($releases as $release) {
            ...
            if ("$major.$minor" != $branch) {
                ...
                $releaseFile->line("\n## $branch");
                if ($major < 2) {
                    $releaseFile->line("*Requires: PHP 5.3 and higher + curl --insecure *\n");
                } elseif ($major == 2 && $minor < 4) {
                    $releaseFile->line("*Requires: PHP 5.4 and higher + curl --insecure *\n");
                } else {
                    $releaseFile->line("*Requires: PHP 5.6 and higher + curl --insecure *\n");
                }

...
{", "},{", $output);
    ...
    public function gauhosts($domain, $randomid, $gauoutputname)
    {
        ...
        $gau = "timeout 5000 sudo docker run --cpu-shares 256 --rm -v dockerresults:/dockerresults sxcurity/gau:latest --blacklist ". $blacklist ." --threads 1 --retries 20 --fc 504,404,302,301 --subs --o ". $name ." " . escapeshellarg($domain) . " ";

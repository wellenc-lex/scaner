...
//--net=host
        $command = ("sudo docker run  --cpu-shares 256 --rm -v configs:/configs/ -v dockerresults:/dockerresults caffix/amass enum -w /configs/amass/amasswordlistASSETNOTE.txt -d  " . escapeshellarg($url) . " -json " . $enumoutput . " -active -brute -timeout 4500 -ip -config ".$amassconfig);
